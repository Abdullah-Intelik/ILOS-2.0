...
Write-Host "[2/5] Starting Document Server (Port 8086)..." -ForegroundColor Yellow
...
Start-Process -FilePath "cmd.exe" -ArgumentList "/k", "cd /d $ILOS_ROOT\ILOS-Mobile-App && adb reverse tcp:5000 tcp:5000 && adb reverse tcp:8086 tcp:8086 && adb reverse tcp:8082 tcp:8082 && npx react-native run-android --port 8082" -WindowStyle Normal
...
Write-Host "   2. Document Server   (Port 8086)" -ForegroundColor Gray
...
Write-Host "   - Documents: http://localhost:8086" -ForegroundColor Cyan
