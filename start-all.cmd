...
echo [2/5] Starting Document Server (Port 8081)...
...
start "ILOS Mobile Build" cmd /k "cd /d %ILOS_ROOT%ILOS-Mobile-App && echo Setting up port forwarding... && adb reverse tcp:5000 tcp:5000 && adb reverse tcp:8081 tcp:8081 && adb reverse tcp:8082 tcp:8082 && echo Building and installing app... && npx react-native run-android --port 8082"
...
echo    2. Document Server   (Port 8081)
...
echo    - Documents: http://localhost:8081
