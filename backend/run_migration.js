...
async function runMigration() {
  try {
    ...
    const formTables = [
      { table: 'cashplus_applications', loan_type: 'cashplus_applications' },
      { table: 'autoloan_applications', loan_type: 'autoloan_applications' },
      { table: 'smeasaan_applications', loan_type: 'smeasaan_applications' },
      { table: 'commercial_vehicle_applications', loan_type: 'commercial_vehicle_applications' },
      { table: 'ameendrive_applications', loan_type: 'ameendrive_applications' },
      { table: 'platinum_card_applications', loan_type: 'platinum_card_applications' },
      { table: 'creditcard_applications', loan_type: 'creditcard_applications' }
    ];
