...
// POST route to insert employment details with blockchain hash
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const hashResult = await createFormHashAfterSubmission(
      d.loan_application_id.toString(),
      department,
      'employment_details',
      d,
      signer
    ...
    res.status(201).json({
      ...
      message: 'Employment details saved successfully with blockchain hash'
    });
