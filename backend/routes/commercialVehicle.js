...
router.post('/', async (req, res) => {
  ...
  if (isMobileSubmission) {
    console.log('📱 Detected mobile app submission for CommercialVehicle - will create pending_pb_completion status');
  }
    ...
    if (isMobileSubmission) {
      ...
      try {
        await client.query(`
          ...
          VALUES ($1, 'commercial_vehicle_applications', $2, $3, 'pending_pb_completion', true, $4, $5)
