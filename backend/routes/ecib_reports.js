...
router.post('/check', async (req, res) => {
  ...
  try {
    ...
    // Return non-error fallback so callers can treat as CLEAR
    console.warn('ECIB check error (fallback to no record):', err.message);
    return res.json({ exists: false, fallback: true });
  }
});
